                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class="wrapper-page">
                            ...
                            <br/>
                            <img src="<c:url value='/resources/images/icons/cancel.svg'/>" alt="에러가 발생하였습니다." height="60" class="m-t-50">
                            <h2 class="text-uppercase text-primary m-t-50">에러가 발생하였습니다.</h2>
                            <p class="text-muted m-t-30">시스템에 문제가 발생하였습니다.<br/>문의사항이 있으신 경우 관리자에게 문의 바랍니다.</p>
