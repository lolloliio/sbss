    ...
    $(document).ready(function () {
	    ...
	    $('#skincareTable tbody').on('click', 'td', function (e) {
            ...
            if (tdIndex != 0){
				...
				$("#skincareId").val(rowData.skincareId);
	        	$("#listForm").submit();
            }
    	});
	    
	    $("#regBtn").click( function() {
	    	location.href = "<c:url value='/skincare/skincareRegistration'/>";
	    });
    });
                    ...
                    <div class="col-sm-12">
                        <div class="card card-border card-warning">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <button type="button" id="regBtn" class="btn btn-warning waves-effect waves-light m-t-20 float-right">등록</button>
                            </div>
                        </div>
                    </div>
                </div>
