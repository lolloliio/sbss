                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title m-0">가맹점 등록</h4>
                        ...
                        <div class="card card-border card-warning">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
										<div class="form-group row">
											<label class="col-md-1 control-label">이름<span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
										<div class="form-group row">
											<label class="col-md-1 control-label">휴대폰번호</label>
											<div class="col-md-11">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
										<div class="form-group row">
											<label class="col-md-1 control-label"><spring:message code="customer.postalCode"/></label>
											<div class="col-md-11 input-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
										<div class="form-group row">
											<label class="col-md-1 control-label"><spring:message code="customer.address"/></label>
											<div class="col-md-11">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">										
										<div class="form-group row">
											<label class="col-md-1 control-label">영업상태</label>
											<div class="col-md-11 input-group">
